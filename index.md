# gdm ![](reference/figures/gdmLogo.png)
...
[`terra`](https://cran.r-project.org/package=terra) package as its
raster processing engine, leading to faster raster file processing.
Preferably, inputs should be provided as `SpatRaster` objects, or any
convertible object to `terra`, such as
[`raster`](https://cran.r-project.org/package=raster) package objects or
...
and [`?gdm`](https://mfitzpatrick.al.umces.edu/gdm/reference/gdm.md) for
more details.
...
![The fitted model (first two panels) and I-splines (remaining
panels).](reference/figures/README-plotGDM-1.png)
...
![Custom I-spline plot for geographic
distance.](reference/figures/README-extractSplines-1.png)
...
![Predicted vs. observed compositional
dissimilarity.](reference/figures/README-predictSpaceGDM-1.png)
...
![Predicted magnitude of biological change through
time](reference/figures/README-predictTimeGDM-1.png)
...
![](reference/figures/README-transformGDM-1.png)
...
contain similar plant
communities.](reference/figures/README-unnamed-chunk-9-1.png)
